...
CHATTERBOX_REPO=${CHATTERBOX_REPO:-https://github.com/resemble-ai/chatterbox.git}
...
install_core_packages() {
  banner "Installing llvmlite/numba/numpy"
  run_pip install "llvmlite==0.41.1" "numba==0.58.1" "numpy==1.25.2"

  banner "Installing PyQt6"
  run_pip install "PyQt6==6.9.1"
}
...
install_project_requirements() {
  banner "Installing remaining requirements"
  run_pip install -r requirements.txt

  banner "Installing chatterbox directly from source"
  run_pip install "git+${CHATTERBOX_REPO}"
}
...
banner "All dependencies installed!"
